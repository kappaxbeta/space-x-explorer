...
import { Grommet, Box, Header, Main,  Text } from 'grommet';
import {
    NavLink
   ...
   const { current } = props;
    ...
    return (
        <Grommet full theme={theme}>
            <Box
             fill="horizontal" overflow="auto" align="start" flex="grow" direction="column" justify="start" pad="medium">
                <Header align="start" direction="row-responsive" flex={true} justify="center" gap="medium" pad="small" fill="vertical" margin={"medium"}>
                    ...
                    <Box align="center" justify="start" round={"small"} pad={"small"} background={current === "history" ?"selected" : "grey"}>
                        <Text>
                            History
                        </Text>
                    </Box>
                ...
                <Main fill="horizontal" flex="grow" overflow="scroll" justify="center" direction="column" align="start" pad="small">
                    {props.children}
                </Main>
            </Box>
        </Grommet>
